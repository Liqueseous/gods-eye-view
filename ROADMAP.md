# God's Eye View Roadmap

This roadmap captures the highest-value features to add to God's Eye View as it evolves from a live global visualization platform into a broader geospatial operations and analyst tool.
...
- cinematic globe exploration

The next step is to expand into operational use cases: monitoring, analysis, briefing, and control.
...
- refresh scheduling
- schema mapping for custom layers
- saved layer presets
...
- briefing and investigation mode
...
- mission brief links
- role-based views
- saved operational briefing bundles
...
- reusable demo presentations

### 10) AR / Immersive Field View
...
Together, these features create a clear bridge from a compelling visualization tool to a broadly useful intelligence and monitoring product.
